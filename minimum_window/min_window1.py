...
def constraint_satisfied(thewindow_string, minimum_window_size, minimum_window):
  """
...
def find_window(searchString, constraint):
  ...
  for right in range(left, n):
    ...
    # Found a window which satisfies the constraint
    # Is it shorter?
    minimum_window_size, minimum_window = constraint_satisfied(thewindow_string, minimum_window_size, minimum_window)
